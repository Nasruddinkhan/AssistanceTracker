/**
 * nasru
 * MyCustomLoginAuthenticationSuccessHandler.java
 * Mar 30, 2020
 */
...
public class MyCustomLoginAuthenticationSuccessHandler<User> implements AuthenticationSuccessHandler {

    private RedirectStrategy redirectStrategy = new DefaultRedirectStrategy();

    @Autowired
    com.mypractice.assistancetracker.model.User activeUserStore;
